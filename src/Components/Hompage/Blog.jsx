...
export default function Blog() {
  return (
    <div className="bg-white py-24 sm:py-32 px-[100px]">
      <div className="mx-auto max-w-full px-6 lg:px-8">
        <div className="w-full flex justify-between items-center">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl font-main">
              From the blog
            </h2>
            <p className="mt-2 text-[16px] leading-8 text-gray-600 font-mnt">
